...
| `ec2-image-id`                                                                                                                                                               | Required if you use the `start` mode.      | SSM parameter name. <br><br> The new runner will be launched with AMI image defined in it. <br><br> The action is compatible with Amazon Linux 2 images.                                                                                                                                                                                           |
